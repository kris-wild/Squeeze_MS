...
####################   ####################   ####################   ####################   
######## Plotting
colors <- c( "#9DB9F1", "#4479E4", "#16439C", "#0D2659", "grey40","darkgoldenrod3", "coral","bisque3", "firebrick4")
...
Forage_Africa_season_2 <- ggplot(Forage_terra_season_africa_dat, aes(x = Climate_Season, 
  ...
  labs(y =  NULL, 
       x = NULL) + 
  scale_y_continuous(limits = c(-24, -12), breaks = seq(-24, -12, by = 6)) +
  theme(legend.position = "none",  # Hide the legend
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 20),
        axis.text.x = element_blank(), 
...
ggsave("../../Pianka_figs/Figure_5.pdf", Figure_5, device = "pdf", width = 22, height =14)
